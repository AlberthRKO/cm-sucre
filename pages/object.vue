<template>
  <Head><Title>Objetivo General - Concejo Municipal de Sucre</Title></Head>
  <main id="main">
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs">
      <div
        class="page-header d-flex align-items-center"
        style="background-image: url('/img/service-details.jpg')"
      >
    ...
    <section id="about" class="about bg-white">
      <div class="container" data-aos="fade-up">
        <div class="row gy-4">
          ...
          >
            <img src="/img/service-details.jpg" class="img-fluid" alt="" />
            <!-- <a
                  href="#"
