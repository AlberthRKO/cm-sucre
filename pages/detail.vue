  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      <div
        ...
        style="background-image: url('/img/features-4.jpg')"
      >
        ...
        <div class="row gy-4 justify-content-center">
          <!-- <div class="col-lg-4">
            <div class="services-list">
              <a href="#titulo" class="active">Tema</a>
              <a href="#discusion">Discusión</a>
              <a href="#solution">Solucion</a>
            </div>

            <h4>Resumen del Blog</h4>
            <p>
          ...
          <div class="col-lg-10">
            <div class="section-header">
              <span>Titulo del Blog</span>
              <h2>Titulo <b>Blog</b></h2>
            </div>
